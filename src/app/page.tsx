        ...
        <div className="relative z-10 space-y-6 w-full">
          ...
          <div className="flex flex-col items-center justify-center gap-1">
            ...
            <div className={`flex items-center justify-center gap-2 mt-4 neon-3d-text-container ${actualSpent > budget ? 'error-neon' : 'primary-neon'}`}>
              <div className="neon-scanner-beam"></div>
              <span className="text-3xl md:text-4xl font-normal font-['Boldonse'] text-transparent" style={{ WebkitTextStroke: '2px var(--neon-color)' }}>$</span>
              <h1 
